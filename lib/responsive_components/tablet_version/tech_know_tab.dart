...
class TechKnowTab extends StatefulWidget {
  const TechKnowTab({super.key});

  @override
  State<TechKnowTab> createState() => _TechKnowTabState();
}

class _TechKnowTabState extends State<TechKnowTab> {
  @override
